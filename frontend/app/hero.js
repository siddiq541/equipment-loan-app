...
const Hero = () => (
  <section className="bg-[#2B2B2B] text-[#FFD9A0] py-16 text-center" aria-labelledby="hero-heading">
    ...
    <form className="flex flex-col md:flex-row justify-center gap-4 max-w-3xl mx-auto" role="search" aria-label="Equipment search">
      <input type="text" placeholder="Search equipment..." className="px-4 py-2 rounded border border-[#C24C30] text-[#2B2B2B]" />
      <input type="text" placeholder="Location" className="px-4 py-2 rounded border border-[#C24C30] text-[#2B2B2B]" />
